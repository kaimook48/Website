              ...
              <ul class="nav nav-tabs">
                ...
                <li :class="{active:tab1Active===1}">
                  <a href="#" @click.prevent="changeTab1(1)"
                     v-if="auth.is_admin || !is_mango()">Create / Edit</a>
                </li>
              </ul>
                        ...
                        <table class="table table-hover table-bordered">
                          <thead>
                            <tr>
                              ...
                              <th class="tf-2 text-center" v-if="auth.is_admin || !is_mango()">Edit</th>
                          ...
                          <tbody>
                            <tr v-for="x,idx in displayData">
                              ...
                              <td align="center" v-if="auth.is_admin || !is_mango()"><a href="#" @click.prevent="edit(x)"><i class="fa fa-edit"></i></a> </td>
                      ...
                      <div class="row">
                        <div class="col-lg-3 col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model.trim="form.flow_code" :readonly="editMode" :disabled="editMode" maxlength="20" />
                          </div>
                        </div>
...
<script>
  ...
  let cpn = {
    ...
    methods: {
      ...
      async readData(x) {
        let act = `csm/master/Flow_Read?code=${encodeURIComponent(x || '')}`;
        let rsp = await $xt.getServer(act);
        this.form = rsp.data;
        this.setEdit();
      },
      ...
      onExport() {
        ...
        XLSX.writeFile(wb, 'Workflow.xlsx');
      },
      async doUpload(f) {
        page.loadingBox.show();
        try {
          let act = `CSM/Master/FlowImport`;
          let fd = new FormData();
          fd.append('file', f);
